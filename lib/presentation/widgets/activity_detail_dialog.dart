      ...
      child: SizedBox(
        ...
        child: Column(
          ...
          children: [
                          ...
                          return Builder(
                            builder: (BuildContext context) {
                              Widget imageWidget = Image.network(
                                picUrl,
                                fit: BoxFit
                                    .contain, // Changed to cover for better fill
            ...
            // The activity details section below the image is removed as it's now an overlay
            // You can re-add it here if you want the details to also appear below the image,
            // but the prompt specifically asked for details "on the pic".
          ],
        ),
      ),
    );
